...
# define variables
MONGO_CMD="mongosh"
MONGO_INIT_KRYPTOS_DBNAME="${MONGO_INIT_KRYPTOS_DBNAME:-THIS_IS_SECRET}"
MONGO_INIT_KRYPTOS_USERNAME="${MONGO_INIT_KRYPTOS_USERNAME:-THIS_IS_SECRET}"
MONGO_INIT_KRYPTOS_PASSWORD="${MONGO_INIT_KRYPTOS_PASSWORD:-THIS_IS_SECRET}"
...
echo "remve all root user in this container"
