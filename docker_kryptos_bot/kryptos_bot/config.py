...
TELEBOT_TOKEN: str = getenv("KRYPTOS_BOT_API_TOKEN")
...
MENU_COMMANDS: list = [
    BotCommand(command="main", description="Main Page"),
    BotCommand(command="management", description="Manage Account"),
    BotCommand(command="search_account", description="Search Accounts"),
...
### CUSTOMIZED CONFIG ###
# API URL FOR KRYPTOS
KRYPTOS_API_URL: str = "http://kryptos-api:8000/"
